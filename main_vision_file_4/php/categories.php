...
if($catval !=''){
    $cart_qurey =  "SELECT * FROM `registeration` WHERE reg_cat= '$catval'";
}
// if($catval == ''){
//      $cart_qurey  = "SELECT * FROM `registeration`";
// }
...
if(isset($_SESSION['user_id'])){
  ...
  $queryQ = "SELECT * FROM `registeration` WHERE NOT `reg_user_id`= $user_id AND reg_cat= '$catval'";
 }
